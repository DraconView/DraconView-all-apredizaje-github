...
export default function RecoverPassword({ navigation }) {
    ...
    const onSubmit = async() => {
        ...
        if (!result.statusResponse) { // si el resultado en su propiedad statusResponse no pudo 
    ...
    return (
        <View style={styles.formContainer}>
            <Input
                ...
                onChange={(e) => setEmail(e.nativeEvent.text)} //[CAP122] cuando cambie recibe un e(event) va almacenar el email 
                defaultValue={email} //por donde inicia 
                errorMessage={errorEmail} // almacenamiento de error 
                keyboardType="email-address" // especial para teclado 
                rightIcon={
                    <Icon
            ...
            <Button
                ...
                onPress={onSubmit} // metodo interno
            />
